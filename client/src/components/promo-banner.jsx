          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="p-8 md:p-12 lg:p-16 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-white text-primary hover:bg-white/90 rounded-full px-8 font-semibold group">
                  Claim Offer
            ...
            { value: "36", label: "Mins" },
            { value: "48", label: "Secs" },
        ].map((item) => (<div key={item.label} className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 text-center min-w-[70px]">
            ...
            return (<div key={`${product.id}-${idx}`} className="relative w-full h-32 md:h-48 rounded-2xl overflow-hidden shadow-md bg-white">
